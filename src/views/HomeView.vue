...
export default {
    ...
    data() {
        return {
            ...
            currentSlide: 0,
            slides: [
                { title: 'Slide 1', image: '../src/assets/image/1.png', content: 'Content for Slide 1' },
                // { title: 'Slide 2', image: '../src/assets/image/2.png', content: 'Content for Slide 2' },
                // { title: 'Slide 3', image: '../src/assets/image/macbook_pro.jpg', content: 'Content for Slide 3' },
